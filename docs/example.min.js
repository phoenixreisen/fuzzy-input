            ...
            return (mithril("article", { class: "fuzzy-search fuzzy-show-result" },
                ...
                mithril("div", { class: attrs.withButton ? 'fuzzy-with-button' : '' },
                    mithril("label", { class: "textfield fuzzy-input " + (attrs.disabled ? 'disabled' : '') },
                        mithril("input", { type: "text", name: "fuzzy", autocomplete: "fuzzy", value: value, id: "" + (attrs.id || ID), readonly: attrs.readonly || false, placeholder: placeholder || '...', maxlength: maxLength || MAXLENGTH, oninput: function (e) { return search(e.target.value, state, attrs); } }),
