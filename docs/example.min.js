    ...
    ***************************************************************************** */
    ...
    var FuzzyInput = (function () {
        ...
        FuzzyInput.prototype.view = function (_a) {
            var state = _a.state, attrs = _a.attrs;
            var loading = state.loading, value = state.value, result = state.result, error = state.error;
            ...
            return (mithril("article", { class: "fuzzy-search fuzzy-show-result" },
                ...
                mithril("div", { class: attrs.withButton ? 'fuzzy-with-button' : '' },
                    mithril("label", { class: "textfield fuzzy-input " + (attrs.disabled ? 'disabled' : '') },
                        mithril("input", { type: "text", name: "fuzzy", value: value, autocomplete: "fuzzy", id: "" + (attrs.id || ID), readonly: attrs.readonly || false, placeholder: placeholder || '...', maxlength: maxLength || MAXLENGTH, oninput: function (e) { return search(e.target.value, state, attrs); } }),
    ...
    var Demo = {
        view: function () {
            return (mithril("div", { class: "fuzzy-demo" },
                ...
                mithril(FuzzyInput, { minLength: 1, id: "example-1", pattern: new RegExp(/[{a-zA-Z]/), label: 'Name eines Landes (engl.)', warnmsg: 'Ungueltige Eingabe', errormsg: 'Huch, ein Fehler ist aufgetreten.', query: function (needle) { return query1(needle); }, load: function (choice) { return load1(choice); } }),
                ...
                mithril(FuzzyInput, { inText: {
                        prefix: '{{',
                        suffix: '}}'
                    }, minLength: 1, id: "example-2", withButton: true, label: 'Irgendwas', pattern: new RegExp(/[{a-zA-Z]/), warnmsg: 'Ungueltige Eingabe', errormsg: 'Huch, ein Fehler ist aufgetreten.', query: function (needle) { return query2(); }, load: function (choice) { return load2(choice); } })));
        }
    };
