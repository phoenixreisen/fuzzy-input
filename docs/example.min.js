    ...
    var FuzzyInput = (function () {
        ...
        FuzzyInput.prototype.view = function (_a) {
            ...
            return (mithril("article", { class: "fuzzy-search fuzzy-show-result" },
                ...
                mithril("div", { class: attrs.inText ? 'fuzzy-with-button' : '' },
        ...
        view: function () {
            return (mithril("div", { class: "fuzzy-demo" },
                ...
                mithril(FuzzyInput, { inText: {
                        prefix: '{{',
                        suffix: '}}'
                    }, minLength: 1, id: "example-2", label: 'Irgendwas', pattern: new RegExp(/[{a-zA-Z]/), warnmsg: 'Ungueltige Eingabe', errormsg: 'Huch, ein Fehler ist aufgetreten.', query: function (needle) { return query2(); }, load: function (choice) { return load2(choice); } })));
        }
    };
