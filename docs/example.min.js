(function () {
    ...
    ***************************************************************************** */
    ...
    function search(input, state, attrs) {
        setTimeout(function () {
    ...
    function load(name, state, attrs) {
    ...
    function focus(state, attrs, e, callback) {
        ...
        if (move && (result === null || result === void 0 ? void 0 : result.length)) {
            state.focused = move();
            var id = "#fuzzy-item-" + state.focused;
    ...
    var FuzzyInput = (function () {
        ...
        FuzzyInput.prototype.oncreate = function (_a) {
            ...
            events.ARROW_DOWN = function (e) { return focus(state, attrs, e); };
        ...
        FuzzyInput.prototype.view = function (_a) {
            var state = _a.state, attrs = _a.attrs;
            var label = attrs.label, maxLength = attrs.maxLength, placeholder = attrs.placeholder;
            var loading = state.loading, value = state.value, result = state.result, error = state.error;
            var showErrormsg = !!(error && (attrs.errormsg !== ''));
            var showResultlist = !!(value && (result === null || result === void 0 ? void 0 : result.map) && !loading);
            ...
            return (mithril("article", { class: "fuzzy-search fuzzy-show-result" },
                showErrormsg &&
                    mithril("div", { class: "bounceIn animated fuzzy-error" },
                ...
                showWarnmsg &&
                    mithril("div", { class: "bounceIn animated fuzzy-warning" },
                ...
                mithril("label", { class: "textfield fuzzy-input " + (attrs.disabled ? 'disabled' : '') },
                    mithril("input", { type: "text", name: "fuzzy", value: value, id: "fuzzy-input", autocomplete: "fuzzy", readonly: attrs.readonly || false, placeholder: placeholder || '...', maxlength: maxLength || MAXLENGTH, oninput: function (e) { return search(e.target.value, state, attrs); } }),
                ...
                showResultlist && [
                    mithril("div", { class: "fuzzy-overlay fuzzy-result fuzzy-style" },
                        mithril("div", { class: "fadeIn animated faster" }, result === null || result === void 0 ? void 0 : result.map(function (name, index) {
                            return mithril("a", { id: "fuzzy-item-" + index, href: "javascript:", onclick: function () { return load(name, state, attrs); } }, name);
                        }))),
    ...
    var Demo = {
        view: function () {
            return (mithril("div", { class: "fuzzy-demo" },
                mithril(FuzzyInput, { minLength: 1, pattern: new RegExp(/[a-zA-Z]/), label: 'Name eines Landes (engl.)', warnmsg: 'Ungueltige Eingabe', errormsg: 'Huch, ein Fehler ist aufgetreten.', query: function (needle) { return query(needle); }, load: function (choice) { return load$1(choice); } })));
        }
    };
